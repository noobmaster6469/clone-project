...
const Navbar = () => {
  return (
    <header className="border-b-1 fixed top-0 left-0 right-0 z-99 bg-white py-2 text-sm">
      <div className="container flex items-center justify-between px-[7vw]">
        ...
        <div className="info flex items-center gap-10  font-semibold">
